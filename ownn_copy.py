...
tensor2 = torch.tensor(bm25_index)


print('time for BM25', time.time()-time3)

tensor_data = {'tensor1': tensor1 , 'tensor2': tensor2}
...
while True:
    ...
    # Search with Faiss
    D, I = index.search(query_embedding, k=6)  # Adjust k as needed
